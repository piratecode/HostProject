 ...
 * 时间： 2016/3/10
 */
public class ProxyActivity extends Activity implements Attachable{

    protected Plugin mRemoteActivity;
    protected ProxyController mProxyController = new ProxyController(this);

    @Override
    public void attach(Plugin activity, PluginManager pluginManager) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProxyController.onCreate(getIntent());
    }
    ...
    public Theme getTheme() {
        return mProxyController.getTheme();
    }

    @Override
    public AssetManager getAssets() {
        return mProxyController.getAssets();
    }

    @Override
    public ClassLoader getClassLoader() {
        return mProxyController.getClassLoader();
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        mRemoteActivity.onActivityResult(resultCode,resultCode,data);
